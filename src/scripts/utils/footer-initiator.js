...
const FooterInitiator = {
  async init({ copyright, subscribeButton, unsubscribeButton }) {
    const currentYear = new Date().getFullYear();
    copyright.innerHTML = `
      <p class="footer__copyright">Copyright &copy; ${currentYear} <span class="footer__name">Restaurant Catalogue</span></p>
    `;
